...
---
title: Fos-related factors-Jun-related factors
...
<img src="COBIND_analysis_report_Fos-related_factors-Jun-related_factors_files/figure-html/spacing-summary-plot-1.png" alt="**Figure 1. Spacings summary plot **" width="9072" />
...
<div class="figure" style="text-align: center">
<img src="COBIND_analysis_report_Fos-related_factors-Jun-related_factors_files/figure-html/no-match-similarity-1.png" alt="**Figure 3. Co-binder motif similarity when no matches in interactions (PPIs) were found for those motif pairs**" width="1440" />
...
#### Species-specific motif library {.active}   
<div class="figure" style="text-align: center">
<img src="COBIND_analysis_report_Fos-related_factors-Jun-related_factors_files/figure-html/no-match-similarity-2.png" alt="**Figure 3. Co-binder motif similarity when no matches in interactions (PPIs) were found for those motif pairs**" width="1440" />
<p class="caption">**Figure 3. Co-binder motif similarity when no matches in interactions (PPIs) were found for those motif pairs**</p>
</div>
### cobinder_10  {.tabset .tabset-pills}    
#### Species-specific motif library {.active}   
<div class="figure" style="text-align: center">
<img src="COBIND_analysis_report_Fos-related_factors-Jun-related_factors_files/figure-html/no-match-similarity-3.png" alt="**Figure 3. Co-binder motif similarity when no matches in interactions (PPIs) were found for those motif pairs**" width="1440" />
<p class="caption">**Figure 3. Co-binder motif similarity when no matches in interactions (PPIs) were found for those motif pairs**</p>
</div>
### cobinder_11  {.tabset .tabset-pills}    
#### Species-specific motif library {.active}   
<div class="figure" style="text-align: center">
<img src="COBIND_analysis_report_Fos-related_factors-Jun-related_factors_files/figure-html/no-match-similarity-4.png" alt="**Figure 3. Co-binder motif similarity when no matches in interactions (PPIs) were found for those motif pairs**" width="1440" />
<p class="caption">**Figure 3. Co-binder motif similarity when no matches in interactions (PPIs) were found for those motif pairs**</p>
</div>
### cobinder_12  {.tabset .tabset-pills}    
#### Species-specific motif library {.active}   
<div class="figure" style="text-align: center">
<img src="COBIND_analysis_report_Fos-related_factors-Jun-related_factors_files/figure-html/no-match-similarity-5.png" alt="**Figure 3. Co-binder motif similarity when no matches in interactions (PPIs) were found for those motif pairs**" width="1440" />
<p class="caption">**Figure 3. Co-binder motif similarity when no matches in interactions (PPIs) were found for those motif pairs**</p>
</div>
### cobinder_2  {.tabset .tabset-pills}    
#### Species-specific motif library {.active}   
<div class="figure" style="text-align: center">
<img src="COBIND_analysis_report_Fos-related_factors-Jun-related_factors_files/figure-html/no-match-similarity-6.png" alt="**Figure 3. Co-binder motif similarity when no matches in interactions (PPIs) were found for those motif pairs**" width="1440" />
<p class="caption">**Figure 3. Co-binder motif similarity when no matches in interactions (PPIs) were found for those motif pairs**</p>
</div>
### cobinder_3  {.tabset .tabset-pills}    
#### Species-specific motif library {.active}   
<div class="figure" style="text-align: center">
<img src="COBIND_analysis_report_Fos-related_factors-Jun-related_factors_files/figure-html/no-match-similarity-7.png" alt="**Figure 3. Co-binder motif similarity when no matches in interactions (PPIs) were found for those motif pairs**" width="1440" />
<p class="caption">**Figure 3. Co-binder motif similarity when no matches in interactions (PPIs) were found for those motif pairs**</p>
</div>
### cobinder_4  {.tabset .tabset-pills}    
#### Species-specific motif library {.active}   
<div class="figure" style="text-align: center">
<img src="COBIND_analysis_report_Fos-related_factors-Jun-related_factors_files/figure-html/no-match-similarity-8.png" alt="**Figure 3. Co-binder motif similarity when no matches in interactions (PPIs) were found for those motif pairs**" width="1440" />
<p class="caption">**Figure 3. Co-binder motif similarity when no matches in interactions (PPIs) were found for those motif pairs**</p>
</div>
### cobinder_5  {.tabset .tabset-pills}    
#### Species-specific motif library {.active}   
<div class="figure" style="text-align: center">
<img src="COBIND_analysis_report_Fos-related_factors-Jun-related_factors_files/figure-html/no-match-similarity-9.png" alt="**Figure 3. Co-binder motif similarity when no matches in interactions (PPIs) were found for those motif pairs**" width="1440" />
<p class="caption">**Figure 3. Co-binder motif similarity when no matches in interactions (PPIs) were found for those motif pairs**</p>
</div>
### cobinder_6  {.tabset .tabset-pills}    
#### Species-specific motif library {.active}   
<div class="figure" style="text-align: center">
<img src="COBIND_analysis_report_Fos-related_factors-Jun-related_factors_files/figure-html/no-match-similarity-10.png" alt="**Figure 3. Co-binder motif similarity when no matches in interactions (PPIs) were found for those motif pairs**" width="1440" />
<p class="caption">**Figure 3. Co-binder motif similarity when no matches in interactions (PPIs) were found for those motif pairs**</p>
</div>
### cobinder_7  {.tabset .tabset-pills}    
#### Species-specific motif library {.active}   
<div class="figure" style="text-align: center">
<img src="COBIND_analysis_report_Fos-related_factors-Jun-related_factors_files/figure-html/no-match-similarity-11.png" alt="**Figure 3. Co-binder motif similarity when no matches in interactions (PPIs) were found for those motif pairs**" width="1440" />
<p class="caption">**Figure 3. Co-binder motif similarity when no matches in interactions (PPIs) were found for those motif pairs**</p>
</div>
### cobinder_8  {.tabset .tabset-pills}    
#### Species-specific motif library {.active}   
<div class="figure" style="text-align: center">
<img src="COBIND_analysis_report_Fos-related_factors-Jun-related_factors_files/figure-html/no-match-similarity-12.png" alt="**Figure 3. Co-binder motif similarity when no matches in interactions (PPIs) were found for those motif pairs**" width="1440" />
<p class="caption">**Figure 3. Co-binder motif similarity when no matches in interactions (PPIs) were found for those motif pairs**</p>
</div>
### cobinder_9  {.tabset .tabset-pills}    
#### Species-specific motif library {.active}   
<div class="figure" style="text-align: center">
<img src="COBIND_analysis_report_Fos-related_factors-Jun-related_factors_files/figure-html/no-match-similarity-13.png" alt="**Figure 3. Co-binder motif similarity when no matches in interactions (PPIs) were found for those motif pairs**" width="1440" />
<p class="caption">**Figure 3. Co-binder motif similarity when no matches in interactions (PPIs) were found for those motif pairs**</p>
</div>
...
<div class="figure">
<img src="COBIND_analysis_report_Fos-related_factors-Jun-related_factors_files/figure-html/annotations-1.png" alt="**Figure 4. Co-binder regions annotations. Co-binder-specific cobinder-only and full (anchor and co-binder) regions together with regions with and without co-binders.**" width="672" />
...
## cobinder_0     
<div class="figure" style="text-align: center">
<img src="COBIND_analysis_report_Fos-related_factors-Jun-related_factors_files/figure-html/conservation-analysis-1.png" alt="**Figure 5. Conservation of regions with and without co-binders.**" width="960" />
<p class="caption">**Figure 5. Conservation of regions with and without co-binders.**</p>
</div>
## cobinder_1     
<div class="figure" style="text-align: center">
<img src="COBIND_analysis_report_Fos-related_factors-Jun-related_factors_files/figure-html/conservation-analysis-2.png" alt="**Figure 5. Conservation of regions with and without co-binders.**" width="960" />
<p class="caption">**Figure 5. Conservation of regions with and without co-binders.**</p>
</div>
## cobinder_10     
<div class="figure" style="text-align: center">
<img src="COBIND_analysis_report_Fos-related_factors-Jun-related_factors_files/figure-html/conservation-analysis-3.png" alt="**Figure 5. Conservation of regions with and without co-binders.**" width="960" />
<p class="caption">**Figure 5. Conservation of regions with and without co-binders.**</p>
</div>
## cobinder_11     
<div class="figure" style="text-align: center">
<img src="COBIND_analysis_report_Fos-related_factors-Jun-related_factors_files/figure-html/conservation-analysis-4.png" alt="**Figure 5. Conservation of regions with and without co-binders.**" width="960" />
<p class="caption">**Figure 5. Conservation of regions with and without co-binders.**</p>
</div>
## cobinder_12     
<div class="figure" style="text-align: center">
<img src="COBIND_analysis_report_Fos-related_factors-Jun-related_factors_files/figure-html/conservation-analysis-5.png" alt="**Figure 5. Conservation of regions with and without co-binders.**" width="960" />
<p class="caption">**Figure 5. Conservation of regions with and without co-binders.**</p>
</div>
## cobinder_2     
<div class="figure" style="text-align: center">
<img src="COBIND_analysis_report_Fos-related_factors-Jun-related_factors_files/figure-html/conservation-analysis-6.png" alt="**Figure 5. Conservation of regions with and without co-binders.**" width="960" />
<p class="caption">**Figure 5. Conservation of regions with and without co-binders.**</p>
</div>
## cobinder_3     
<div class="figure" style="text-align: center">
<img src="COBIND_analysis_report_Fos-related_factors-Jun-related_factors_files/figure-html/conservation-analysis-7.png" alt="**Figure 5. Conservation of regions with and without co-binders.**" width="960" />
<p class="caption">**Figure 5. Conservation of regions with and without co-binders.**</p>
</div>
## cobinder_4     
<div class="figure" style="text-align: center">
<img src="COBIND_analysis_report_Fos-related_factors-Jun-related_factors_files/figure-html/conservation-analysis-8.png" alt="**Figure 5. Conservation of regions with and without co-binders.**" width="960" />
<p class="caption">**Figure 5. Conservation of regions with and without co-binders.**</p>
</div>
## cobinder_5     
<div class="figure" style="text-align: center">
<img src="COBIND_analysis_report_Fos-related_factors-Jun-related_factors_files/figure-html/conservation-analysis-9.png" alt="**Figure 5. Conservation of regions with and without co-binders.**" width="960" />
<p class="caption">**Figure 5. Conservation of regions with and without co-binders.**</p>
</div>
## cobinder_6     
<div class="figure" style="text-align: center">
<img src="COBIND_analysis_report_Fos-related_factors-Jun-related_factors_files/figure-html/conservation-analysis-10.png" alt="**Figure 5. Conservation of regions with and without co-binders.**" width="960" />
<p class="caption">**Figure 5. Conservation of regions with and without co-binders.**</p>
</div>
## cobinder_7     
<div class="figure" style="text-align: center">
<img src="COBIND_analysis_report_Fos-related_factors-Jun-related_factors_files/figure-html/conservation-analysis-11.png" alt="**Figure 5. Conservation of regions with and without co-binders.**" width="960" />
<p class="caption">**Figure 5. Conservation of regions with and without co-binders.**</p>
</div>
## cobinder_8     
<div class="figure" style="text-align: center">
<img src="COBIND_analysis_report_Fos-related_factors-Jun-related_factors_files/figure-html/conservation-analysis-12.png" alt="**Figure 5. Conservation of regions with and without co-binders.**" width="960" />
<p class="caption">**Figure 5. Conservation of regions with and without co-binders.**</p>
</div>
## cobinder_9     
<div class="figure" style="text-align: center">
<img src="COBIND_analysis_report_Fos-related_factors-Jun-related_factors_files/figure-html/conservation-analysis-13.png" alt="**Figure 5. Conservation of regions with and without co-binders.**" width="960" />
<p class="caption">**Figure 5. Conservation of regions with and without co-binders.**</p>
</div>
