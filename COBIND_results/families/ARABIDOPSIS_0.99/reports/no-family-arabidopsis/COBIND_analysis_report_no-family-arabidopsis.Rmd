...
## Spacings:
spacings.heatmap.file               <- "/storage/scratch/ieva/COBIND_results/families/ARABIDOPSIS_0.99/results/clustering_results/no-family-arabidopsis/spacings/TF_cobinder_spacer_plot_no-family-arabidopsis.RData"
spacings.summary.tab.file           <- "/storage/scratch/ieva/COBIND_results/families/ARABIDOPSIS_0.99/results/clustering_results/no-family-arabidopsis/spacings/spacings_summary.RData"

## Cobinder regions:
cobinder.regions.dir                <- "/storage/scratch/ieva/COBIND_results/families/ARABIDOPSIS_0.99/results/cobinder_regions/BED"

## PPI:
PPI.motif.similarity.files          <- "/storage/scratch/ieva/COBIND_results/families/ARABIDOPSIS_0.99/results/ppi_associations_results/physical/no-family-arabidopsis/cobinder_0_motif_similarity_PPI_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/families/ARABIDOPSIS_0.99/results/ppi_associations_results/physical/no-family-arabidopsis/cobinder_1_motif_similarity_PPI_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/families/ARABIDOPSIS_0.99/results/ppi_associations_results/physical/no-family-arabidopsis/cobinder_2_motif_similarity_PPI_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/families/ARABIDOPSIS_0.99/results/ppi_associations_results/physical/no-family-arabidopsis/cobinder_3_motif_similarity_PPI_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/families/ARABIDOPSIS_0.99/results/ppi_associations_results/physical/no-family-arabidopsis/cobinder_4_motif_similarity_PPI_plot_with_alignment.RData"
no.mach.motif.similarity.files      <- "/storage/scratch/ieva/COBIND_results/families/ARABIDOPSIS_0.99/results/ppi_associations_results/physical/no-family-arabidopsis/cobinder_0_no_match_motif_similarity_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/families/ARABIDOPSIS_0.99/results/ppi_associations_results/physical/no-family-arabidopsis/cobinder_1_no_match_motif_similarity_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/families/ARABIDOPSIS_0.99/results/ppi_associations_results/physical/no-family-arabidopsis/cobinder_2_no_match_motif_similarity_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/families/ARABIDOPSIS_0.99/results/ppi_associations_results/physical/no-family-arabidopsis/cobinder_3_no_match_motif_similarity_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/families/ARABIDOPSIS_0.99/results/ppi_associations_results/physical/no-family-arabidopsis/cobinder_4_no_match_motif_similarity_plot_with_alignment.RData"

confirmed.pairs.tab.file            <- "/storage/scratch/ieva/COBIND_results/families/ARABIDOPSIS_0.99/results/ppi_associations_results/physical/no-family-arabidopsis/motif_ppi_confirmed_pairs.txt"
novel.predictions.file              <- "/storage/scratch/ieva/COBIND_results/families/ARABIDOPSIS_0.99/results/ppi_associations_results/physical/no-family-arabidopsis/novel_cobinder_predictions.txt"
confirmed.pairs.full.tab.file       <- "/storage/scratch/ieva/COBIND_results/families/ARABIDOPSIS_0.99/results/ppi_associations_results/physical_full/no-family-arabidopsis/motif_ppi_confirmed_pairs.txt"
novel.predictions.full.file         <- "/storage/scratch/ieva/COBIND_results/families/ARABIDOPSIS_0.99/results/ppi_associations_results/physical_full/no-family-arabidopsis/novel_cobinder_predictions.txt"
...
centered.region.anno                <- "/storage/scratch/ieva/COBIND_results/families/ARABIDOPSIS_0.99/results/cobinder_regions_annotation/centered/no-family-arabidopsis_chipseeker.RData"

## Conservation:

conservation.plot.files             <- "NA"
conservation.statistics.tab.file    <- "/storage/scratch/ieva/COBIND_results/families/ARABIDOPSIS_0.99/results/conservation_analysis/no-family-arabidopsis/conservation_statistics/wilcox_test_no_vs_with_cobinder.txt"
...
<div align = "justify">
To infer what transcription factor (TF) could be co-binding together with the anchor TF, we compare discovered co-binder motifs against the collection of know motifs (JASPAR and CIS-BP species-specific and pooled motif collections). Then, we search the protein-protein interaction data from STRING for these co-binder pairs. If such pair is found with significance, we confirm it as a validated anchor-co-binder pair (Figure 3). If the pair is not found in PPI data, we predict the TF based on motif similarity with know motifs (Figure 4).
</div>
...
```{r confirmed-pairs, cache = TRUE, echo = FALSE, eval = TRUE, fig.cap = "**Table 2A. Significant co-binding pairs, based on motif similarity (using species-specfic library) and PPI data**", fig.align = "center"}
...
```{r predicted-pairs, cache = TRUE, echo = FALSE, eval = TRUE, fig.cap = "**Table 3A. Significant co-binder TFs, inferred using motif comparison with species-specific motif library and when such pairs are not found in PPI data** (displaying top100 significant p-values)", fig.align = "center"}
...
<!-- ### Regions with and without the co-binder -->

<!-- The pipeline output co-binder-specific and differently summarized regions. Bellow -->
<!-- is the list of available regions. -->

<!-- <p>&nbsp;</p> -->

<!-- ```{r cobinder-regions, cache = TRUE, echo = FALSE, eval = TRUE, include = TRUE, fig.cap = "Table 2. Available genomic regions with and without co-binders.", fig.align = "center"} -->

<!-- ## Table: -->
<!-- cobinder.regions.tab <- load(cobinder.regions.tab.file) -->
<!-- cobinder.regions.tab <- get(cobinder.regions.tab) -->

<!-- cobinder.regions.tab <- cobinder.regions.tab -->
<!-- #   select(Subcluster, Dataset, Flank, -->
<!-- #          Nb_components, Component, -->
<!-- #          Spacer_length, Location, -->
<!-- #          Nb_regions_in_input_bed, Nb_regions_with_cobinder, Fraction_of_regions_with_cobinder, -->
<!-- #          Nb_datasets, Cobinder_proportion) -->
...
<!-- datatable(cobinder.regions.tab, -->
<!--           style = "default", -->
<!--           rownames = FALSE, -->
<!--           options = list(scrollX = TRUE)) -->
...
<!-- ####Boxplot (they are not always very nice, so I put this into comments for now.) -->
<!-- <p>&nbsp;</p> -->
<!-- <p>&nbsp;</p> -->

<!-- ```{r spacing_summary_boxplot_size, cache = TRUE, echo = FALSE, eval = TRUE, include = TRUE} -->

<!-- spacings.boxplot.size <- load(spacings.heatmap.file) -->
<!-- boxplot.w <-ifelse(estimated.w > 25, yes = estimated.w, no = 25) -->

<!-- ``` -->

<!-- ```{r spacing_summary_boxplot, cache = TRUE, echo = FALSE, eval = TRUE, include = TRUE, fig.cap = "**Figure 2. Spacings summary boxplot**", fig.align = "center", fig.height = 22, fig.width = boxplot.w} -->

<!-- ## Plot: -->
<!-- spacings.boxplot <- load(spacings.boxplot.file) -->
<!-- spacings.boxplot <- boxplot.plus.logos -->
<!-- spacings.boxplot -->
