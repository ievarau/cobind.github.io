...
## Spacings:
spacings.heatmap.file               <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/clustering_results/FOS/spacings/TF_cobinder_spacer_plot_FOS.RData"
spacings.summary.tab.file           <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/clustering_results/FOS/spacings/spacings_summary.RData"

## Cobinder regions:
cobinder.regions.dir                <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/cobinder_regions/BED"

## PPI:
PPI.motif.similarity.files          <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/ppi_associations_results/physical/FOS/cobinder_0_motif_similarity_PPI_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/ppi_associations_results/physical/FOS/cobinder_1_motif_similarity_PPI_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/ppi_associations_results/physical/FOS/cobinder_2_motif_similarity_PPI_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/ppi_associations_results/physical/FOS/cobinder_3_motif_similarity_PPI_plot_with_alignment.RData"
no.mach.motif.similarity.files      <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/ppi_associations_results/physical/FOS/cobinder_0_no_match_motif_similarity_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/ppi_associations_results/physical/FOS/cobinder_1_no_match_motif_similarity_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/ppi_associations_results/physical/FOS/cobinder_2_no_match_motif_similarity_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/ppi_associations_results/physical/FOS/cobinder_3_no_match_motif_similarity_plot_with_alignment.RData"

confirmed.pairs.tab.file            <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/ppi_associations_results/physical/FOS/motif_ppi_confirmed_pairs.txt"
novel.predictions.file              <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/ppi_associations_results/physical/FOS/novel_cobinder_predictions.txt"
confirmed.pairs.full.tab.file       <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/ppi_associations_results/physical_full/FOS/motif_ppi_confirmed_pairs.txt"
novel.predictions.full.file         <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/ppi_associations_results/physical_full/FOS/novel_cobinder_predictions.txt"
...
centered.region.anno                <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/cobinder_regions_annotation/centered/FOS_chipseeker.RData"

## Conservation:

conservation.plot.files             <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/conservation_analysis/FOS/full_motif_specific/cobinder_0_right_7/cobinder_vs_none_of_cobinders.RData,/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/conservation_analysis/FOS/full_motif_specific/cobinder_1_left_6/cobinder_vs_none_of_cobinders.RData,/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/conservation_analysis/FOS/full_motif_specific/cobinder_2_right_2/cobinder_vs_none_of_cobinders.RData,/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/conservation_analysis/FOS/full_motif_specific/cobinder_3_right_0/cobinder_vs_none_of_cobinders.RData"
conservation.statistics.tab.file    <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/conservation_analysis/FOS/conservation_statistics/wilcox_test_no_vs_with_cobinder.txt"

## GREAT:

great.plot.dirs                     <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/GREAT_analysis/FOS/cobinder_specific/cobinder_0,/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/GREAT_analysis/FOS/cobinder_specific/cobinder_1,/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/GREAT_analysis/FOS/cobinder_specific/cobinder_2,/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/GREAT_analysis/FOS/cobinder_specific/cobinder_3"
