...
## Spacings:
spacings.heatmap.file               <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/clustering_results/PPARG/spacings/TF_cobinder_spacer_plot_PPARG.RData"
spacings.summary.tab.file           <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/clustering_results/PPARG/spacings/spacings_summary.RData"

## Cobinder regions:
cobinder.regions.dir                <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/cobinder_regions/BED"

## PPI:
PPI.motif.similarity.files          <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/ppi_associations_results/physical/PPARG/cobinder_0_motif_similarity_PPI_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/ppi_associations_results/physical/PPARG/cobinder_1_motif_similarity_PPI_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/ppi_associations_results/physical/PPARG/cobinder_2_motif_similarity_PPI_plot_with_alignment.RData"
no.mach.motif.similarity.files      <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/ppi_associations_results/physical/PPARG/cobinder_0_no_match_motif_similarity_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/ppi_associations_results/physical/PPARG/cobinder_1_no_match_motif_similarity_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/ppi_associations_results/physical/PPARG/cobinder_2_no_match_motif_similarity_plot_with_alignment.RData"

confirmed.pairs.tab.file            <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/ppi_associations_results/physical/PPARG/motif_ppi_confirmed_pairs.txt"
novel.predictions.file              <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/ppi_associations_results/physical/PPARG/novel_cobinder_predictions.txt"
confirmed.pairs.full.tab.file       <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/ppi_associations_results/physical_full/PPARG/motif_ppi_confirmed_pairs.txt"
novel.predictions.full.file         <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/ppi_associations_results/physical_full/PPARG/novel_cobinder_predictions.txt"
...
centered.region.anno                <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/cobinder_regions_annotation/centered/PPARG_chipseeker.RData"

## Conservation:

conservation.plot.files             <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/conservation_analysis/PPARG/full_motif_specific/cobinder_0_left_3/cobinder_vs_none_of_cobinders.RData,/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/conservation_analysis/PPARG/full_motif_specific/cobinder_1_left_3/cobinder_vs_none_of_cobinders.RData,/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/conservation_analysis/PPARG/full_motif_specific/cobinder_2_left_3/cobinder_vs_none_of_cobinders.RData"
conservation.statistics.tab.file    <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/conservation_analysis/PPARG/conservation_statistics/wilcox_test_no_vs_with_cobinder.txt"

## GREAT:

great.plot.dirs                     <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/GREAT_analysis/PPARG/cobinder_specific/cobinder_0,/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/GREAT_analysis/PPARG/cobinder_specific/cobinder_1,/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/GREAT_analysis/PPARG/cobinder_specific/cobinder_2"
