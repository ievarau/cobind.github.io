...
## Spacings:
spacings.heatmap.file               <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/clustering_results/TEAD2/spacings/TF_cobinder_spacer_plot_TEAD2.RData"
spacings.summary.tab.file           <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/clustering_results/TEAD2/spacings/spacings_summary.RData"

## Cobinder regions:
cobinder.regions.dir                <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/cobinder_regions/BED"

## PPI:
PPI.motif.similarity.files          <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/ppi_associations_results/physical/TEAD2/cobinder_0_motif_similarity_PPI_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/ppi_associations_results/physical/TEAD2/cobinder_1_motif_similarity_PPI_plot_with_alignment.RData"
no.mach.motif.similarity.files      <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/ppi_associations_results/physical/TEAD2/cobinder_0_no_match_motif_similarity_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/ppi_associations_results/physical/TEAD2/cobinder_1_no_match_motif_similarity_plot_with_alignment.RData"

confirmed.pairs.tab.file            <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/ppi_associations_results/physical/TEAD2/motif_ppi_confirmed_pairs.txt"
novel.predictions.file              <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/ppi_associations_results/physical/TEAD2/novel_cobinder_predictions.txt"
confirmed.pairs.full.tab.file       <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/ppi_associations_results/physical_full/TEAD2/motif_ppi_confirmed_pairs.txt"
novel.predictions.full.file         <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/ppi_associations_results/physical_full/TEAD2/novel_cobinder_predictions.txt"
...
centered.region.anno                <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/cobinder_regions_annotation/centered/TEAD2_chipseeker.RData"

## Conservation:

conservation.plot.files             <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/conservation_analysis/TEAD2/full_motif_specific/cobinder_0_right_5/cobinder_vs_none_of_cobinders.RData,/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/conservation_analysis/TEAD2/full_motif_specific/cobinder_1_right_5/cobinder_vs_none_of_cobinders.RData"
conservation.statistics.tab.file    <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/conservation_analysis/TEAD2/conservation_statistics/wilcox_test_no_vs_with_cobinder.txt"

## GREAT:

great.plot.dirs                     <- "/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/GREAT_analysis/TEAD2/cobinder_specific/cobinder_0,/storage/scratch/ieva/COBIND_results/individual/MOUSE_0.99/results/GREAT_analysis/TEAD2/cobinder_specific/cobinder_1"
