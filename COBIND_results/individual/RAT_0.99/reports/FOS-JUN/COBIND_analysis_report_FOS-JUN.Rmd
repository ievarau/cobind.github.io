...
## Spacings:
spacings.heatmap.file               <- "/storage/scratch/ieva/COBIND_results/individual/RAT_0.99/results/clustering_results/FOS-JUN/spacings/TF_cobinder_spacer_plot_FOS-JUN.RData"
spacings.summary.tab.file           <- "/storage/scratch/ieva/COBIND_results/individual/RAT_0.99/results/clustering_results/FOS-JUN/spacings/spacings_summary.RData"
...
no.mach.motif.similarity.files      <- "/storage/scratch/ieva/COBIND_results/individual/RAT_0.99/results/ppi_associations_results/physical/FOS-JUN/cobinder_0_no_match_motif_similarity_plot_with_alignment.RData"

confirmed.pairs.tab.file            <- "/storage/scratch/ieva/COBIND_results/individual/RAT_0.99/results/ppi_associations_results/physical/FOS-JUN/motif_ppi_confirmed_pairs.txt"
novel.predictions.file              <- "/storage/scratch/ieva/COBIND_results/individual/RAT_0.99/results/ppi_associations_results/physical/FOS-JUN/novel_cobinder_predictions.txt"
confirmed.pairs.full.tab.file       <- "/storage/scratch/ieva/COBIND_results/individual/RAT_0.99/results/ppi_associations_results/physical_full/FOS-JUN/motif_ppi_confirmed_pairs.txt"
novel.predictions.full.file         <- "/storage/scratch/ieva/COBIND_results/individual/RAT_0.99/results/ppi_associations_results/physical_full/FOS-JUN/novel_cobinder_predictions.txt"
...
centered.region.anno                <- "/storage/scratch/ieva/COBIND_results/individual/RAT_0.99/results/cobinder_regions_annotation/centered/FOS-JUN_chipseeker.RData"

## Conservation:

conservation.plot.files             <- "NA"
conservation.statistics.tab.file    <- "/storage/scratch/ieva/COBIND_results/individual/RAT_0.99/results/conservation_analysis/FOS-JUN/conservation_statistics/wilcox_test_no_vs_with_cobinder.txt"
