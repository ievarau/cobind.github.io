...
## Spacings:
spacings.heatmap.file               <- "/storage/scratch/ieva/COBIND_results/individual/RAT_0.99/results/clustering_results/FOSL1-JUN/spacings/TF_cobinder_spacer_plot_FOSL1-JUN.RData"
spacings.summary.tab.file           <- "/storage/scratch/ieva/COBIND_results/individual/RAT_0.99/results/clustering_results/FOSL1-JUN/spacings/spacings_summary.RData"
...
no.mach.motif.similarity.files      <- "/storage/scratch/ieva/COBIND_results/individual/RAT_0.99/results/ppi_associations_results/physical/FOSL1-JUN/cobinder_0_no_match_motif_similarity_plot_with_alignment.RData"

confirmed.pairs.tab.file            <- "/storage/scratch/ieva/COBIND_results/individual/RAT_0.99/results/ppi_associations_results/physical/FOSL1-JUN/motif_ppi_confirmed_pairs.txt"
novel.predictions.file              <- "/storage/scratch/ieva/COBIND_results/individual/RAT_0.99/results/ppi_associations_results/physical/FOSL1-JUN/novel_cobinder_predictions.txt"
confirmed.pairs.full.tab.file       <- "/storage/scratch/ieva/COBIND_results/individual/RAT_0.99/results/ppi_associations_results/physical_full/FOSL1-JUN/motif_ppi_confirmed_pairs.txt"
novel.predictions.full.file         <- "/storage/scratch/ieva/COBIND_results/individual/RAT_0.99/results/ppi_associations_results/physical_full/FOSL1-JUN/novel_cobinder_predictions.txt"
...
centered.region.anno                <- "/storage/scratch/ieva/COBIND_results/individual/RAT_0.99/results/cobinder_regions_annotation/centered/FOSL1-JUN_chipseeker.RData"

## Conservation:

conservation.plot.files             <- "NA"
conservation.statistics.tab.file    <- "/storage/scratch/ieva/COBIND_results/individual/RAT_0.99/results/conservation_analysis/FOSL1-JUN/conservation_statistics/wilcox_test_no_vs_with_cobinder.txt"
