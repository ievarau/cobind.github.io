...
## Spacings:
spacings.heatmap.file               <- "/storage/scratch/ieva/COBIND_results/individual/RAT_0.99/results/clustering_results/SOX10/spacings/TF_cobinder_spacer_plot_SOX10.RData"
spacings.summary.tab.file           <- "/storage/scratch/ieva/COBIND_results/individual/RAT_0.99/results/clustering_results/SOX10/spacings/spacings_summary.RData"

## Cobinder regions:
cobinder.regions.dir                <- "/storage/scratch/ieva/COBIND_results/individual/RAT_0.99/results/cobinder_regions/BED"

## PPI:
PPI.motif.similarity.files          <- "/storage/scratch/ieva/COBIND_results/individual/RAT_0.99/results/ppi_associations_results/physical/SOX10/cobinder_0_motif_similarity_PPI_plot_with_alignment.RData"
no.mach.motif.similarity.files      <- "/storage/scratch/ieva/COBIND_results/individual/RAT_0.99/results/ppi_associations_results/physical/SOX10/cobinder_0_no_match_motif_similarity_plot_with_alignment.RData"

confirmed.pairs.tab.file            <- "/storage/scratch/ieva/COBIND_results/individual/RAT_0.99/results/ppi_associations_results/physical/SOX10/motif_ppi_confirmed_pairs.txt"
novel.predictions.file              <- "/storage/scratch/ieva/COBIND_results/individual/RAT_0.99/results/ppi_associations_results/physical/SOX10/novel_cobinder_predictions.txt"
confirmed.pairs.full.tab.file       <- "/storage/scratch/ieva/COBIND_results/individual/RAT_0.99/results/ppi_associations_results/physical_full/SOX10/motif_ppi_confirmed_pairs.txt"
novel.predictions.full.file         <- "/storage/scratch/ieva/COBIND_results/individual/RAT_0.99/results/ppi_associations_results/physical_full/SOX10/novel_cobinder_predictions.txt"
...
centered.region.anno                <- "/storage/scratch/ieva/COBIND_results/individual/RAT_0.99/results/cobinder_regions_annotation/centered/SOX10_chipseeker.RData"

## Conservation:

conservation.plot.files             <- "NA"
conservation.statistics.tab.file    <- "/storage/scratch/ieva/COBIND_results/individual/RAT_0.99/results/conservation_analysis/SOX10/conservation_statistics/wilcox_test_no_vs_with_cobinder.txt"
