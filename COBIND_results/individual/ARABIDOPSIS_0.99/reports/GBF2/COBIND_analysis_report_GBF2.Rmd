...
## Spacings:
spacings.heatmap.file               <- "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/clustering_results/GBF2/spacings/TF_cobinder_spacer_plot_GBF2.RData"
spacings.summary.tab.file           <- "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/clustering_results/GBF2/spacings/spacings_summary.RData"
...
no.mach.motif.similarity.files      <- "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/ppi_associations_results/physical/GBF2/cobinder_0_no_match_motif_similarity_plot_with_alignment.RData"

confirmed.pairs.tab.file            <- "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/ppi_associations_results/physical/GBF2/motif_ppi_confirmed_pairs.txt"
novel.predictions.file              <- "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/ppi_associations_results/physical/GBF2/novel_cobinder_predictions.txt"
confirmed.pairs.full.tab.file       <- "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/ppi_associations_results/physical_full/GBF2/motif_ppi_confirmed_pairs.txt"
novel.predictions.full.file         <- "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/ppi_associations_results/physical_full/GBF2/novel_cobinder_predictions.txt"

# ## Goos PPI:
# goos.ppi.dir    <- "--goos_ppi_dir--"

## PPI:
goos.PPI.motif.similarity.files          <- "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/ppi_associations_results/goos/GBF2/cobinder_0_motif_similarity_PPI_plot_with_alignment.RData"
goos.no.mach.motif.similarity.files      <- "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/ppi_associations_results/goos/GBF2/cobinder_0_no_match_motif_similarity_plot_with_alignment.RData"

goos.confirmed.pairs.tab.file            <- "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/ppi_associations_results/goos/GBF2/motif_ppi_confirmed_pairs.txt"
goos.novel.predictions.file              <- "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/ppi_associations_results/goos/GBF2/novel_cobinder_predictions.txt"
goos.confirmed.pairs.full.tab.file       <- "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/ppi_associations_results/goos_full/GBF2/motif_ppi_confirmed_pairs.txt"
goos.novel.predictions.full.file         <- "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/ppi_associations_results/goos_full/GBF2/novel_cobinder_predictions.txt"


## Region annotations:

centered.region.anno                <- "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/cobinder_regions_annotation/centered/GBF2_chipseeker.RData"

## Conservation:

conservation.plot.files             <- "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/conservation_analysis/GBF2/full_motif_specific/cobinder_0_right_4/cobinder_vs_none_of_cobinders.RData"
conservation.statistics.tab.file    <- "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/conservation_analysis/GBF2/conservation_statistics/wilcox_test_no_vs_with_cobinder.txt"
...
<!-- ## determining, if a list is not empty: -->
<!-- if (as.character(goos.PPI.motif.similarity.files) != "NA" | goos.PPI.motif.similarity.files != "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/ppi_associations_results/goos/GBF2/cobinder_0_motif_similarity_PPI_plot_with_alignment.RData") { -->
...
<!-- if (as.character(goos.PPI.motif.similarity.files)[1] != "NA" | goos.PPI.motif.similarity.files != "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/ppi_associations_results/goos/GBF2/cobinder_0_motif_similarity_PPI_plot_with_alignment.RData") { -->
