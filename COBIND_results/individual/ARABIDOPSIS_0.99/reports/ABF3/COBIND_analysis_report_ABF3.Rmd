...
## Spacings:
spacings.heatmap.file               <- "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/clustering_results/ABF3/spacings/TF_cobinder_spacer_plot_ABF3.RData"
spacings.summary.tab.file           <- "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/clustering_results/ABF3/spacings/spacings_summary.RData"

## Cobinder regions:
cobinder.regions.dir                <- "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/cobinder_regions/BED"

## PPI:
PPI.motif.similarity.files          <- "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/ppi_associations_results/physical/ABF3/cobinder_0_motif_similarity_PPI_plot_with_alignment.RData"
no.mach.motif.similarity.files      <- "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/ppi_associations_results/physical/ABF3/cobinder_0_no_match_motif_similarity_plot_with_alignment.RData"

confirmed.pairs.tab.file            <- "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/ppi_associations_results/physical/ABF3/motif_ppi_confirmed_pairs.txt"
novel.predictions.file              <- "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/ppi_associations_results/physical/ABF3/novel_cobinder_predictions.txt"
confirmed.pairs.full.tab.file       <- "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/ppi_associations_results/physical_full/ABF3/motif_ppi_confirmed_pairs.txt"
novel.predictions.full.file         <- "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/ppi_associations_results/physical_full/ABF3/novel_cobinder_predictions.txt"
...
goos.no.mach.motif.similarity.files      <- "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/ppi_associations_results/goos/ABF3/cobinder_0_no_match_motif_similarity_plot_with_alignment.RData"

goos.confirmed.pairs.tab.file            <- "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/ppi_associations_results/goos/ABF3/motif_ppi_confirmed_pairs.txt"
goos.novel.predictions.file              <- "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/ppi_associations_results/goos/ABF3/novel_cobinder_predictions.txt"
goos.confirmed.pairs.full.tab.file       <- "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/ppi_associations_results/goos_full/ABF3/motif_ppi_confirmed_pairs.txt"
goos.novel.predictions.full.file         <- "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/ppi_associations_results/goos_full/ABF3/novel_cobinder_predictions.txt"


## Region annotations:

centered.region.anno                <- "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/cobinder_regions_annotation/centered/ABF3_chipseeker.RData"

## Conservation:

conservation.plot.files             <- "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/conservation_analysis/ABF3/full_motif_specific/cobinder_0_right_5/cobinder_vs_none_of_cobinders.RData"
conservation.statistics.tab.file    <- "/storage/scratch/ieva/COBIND_results/individual/ARABIDOPSIS_0.99/results/conservation_analysis/ABF3/conservation_statistics/wilcox_test_no_vs_with_cobinder.txt"
