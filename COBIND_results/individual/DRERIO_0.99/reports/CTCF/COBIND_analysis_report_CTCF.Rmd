...
## Spacings:
spacings.heatmap.file               <- "/storage/scratch/ieva/COBIND_results/individual/DRERIO_0.99/results/clustering_results/CTCF/spacings/TF_cobinder_spacer_plot_CTCF.RData"
spacings.summary.tab.file           <- "/storage/scratch/ieva/COBIND_results/individual/DRERIO_0.99/results/clustering_results/CTCF/spacings/spacings_summary.RData"

## Cobinder regions:
cobinder.regions.dir                <- "/storage/scratch/ieva/COBIND_results/individual/DRERIO_0.99/results/cobinder_regions/BED"

## PPI:
PPI.motif.similarity.files          <- "/storage/scratch/ieva/COBIND_results/individual/DRERIO_0.99/results/ppi_associations_results/physical/CTCF/cobinder_0_motif_similarity_PPI_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/individual/DRERIO_0.99/results/ppi_associations_results/physical/CTCF/cobinder_1_motif_similarity_PPI_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/individual/DRERIO_0.99/results/ppi_associations_results/physical/CTCF/cobinder_2_motif_similarity_PPI_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/individual/DRERIO_0.99/results/ppi_associations_results/physical/CTCF/cobinder_3_motif_similarity_PPI_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/individual/DRERIO_0.99/results/ppi_associations_results/physical/CTCF/cobinder_4_motif_similarity_PPI_plot_with_alignment.RData"
no.mach.motif.similarity.files      <- "/storage/scratch/ieva/COBIND_results/individual/DRERIO_0.99/results/ppi_associations_results/physical/CTCF/cobinder_0_no_match_motif_similarity_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/individual/DRERIO_0.99/results/ppi_associations_results/physical/CTCF/cobinder_1_no_match_motif_similarity_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/individual/DRERIO_0.99/results/ppi_associations_results/physical/CTCF/cobinder_2_no_match_motif_similarity_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/individual/DRERIO_0.99/results/ppi_associations_results/physical/CTCF/cobinder_3_no_match_motif_similarity_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/individual/DRERIO_0.99/results/ppi_associations_results/physical/CTCF/cobinder_4_no_match_motif_similarity_plot_with_alignment.RData"

confirmed.pairs.tab.file            <- "/storage/scratch/ieva/COBIND_results/individual/DRERIO_0.99/results/ppi_associations_results/physical/CTCF/motif_ppi_confirmed_pairs.txt"
novel.predictions.file              <- "/storage/scratch/ieva/COBIND_results/individual/DRERIO_0.99/results/ppi_associations_results/physical/CTCF/novel_cobinder_predictions.txt"
confirmed.pairs.full.tab.file       <- "/storage/scratch/ieva/COBIND_results/individual/DRERIO_0.99/results/ppi_associations_results/physical_full/CTCF/motif_ppi_confirmed_pairs.txt"
novel.predictions.full.file         <- "/storage/scratch/ieva/COBIND_results/individual/DRERIO_0.99/results/ppi_associations_results/physical_full/CTCF/novel_cobinder_predictions.txt"
...
centered.region.anno                <- "/storage/scratch/ieva/COBIND_results/individual/DRERIO_0.99/results/cobinder_regions_annotation/centered/CTCF_chipseeker.RData"

## Conservation:

conservation.plot.files             <- "NA"
conservation.statistics.tab.file    <- "/storage/scratch/ieva/COBIND_results/individual/DRERIO_0.99/results/conservation_analysis/CTCF/conservation_statistics/wilcox_test_no_vs_with_cobinder.txt"
...
if (file.exists(confirmed.pairs.tab.file)) {
  ...
  # confirmed.pairs.tab$p_value <- round(confirmed.pairs.tab$p_value, digits = 3)
  # print(confirmed.pairs.tab)
...
```{r goos-predicted-pairs, cache = TRUE, echo = FALSE, eval = TRUE, fig.cap = "**Table 3A-H. Significant co-binder TFs, inferred using motif comparison with species-specific motif library and when such pairs are not found in PPI Goos et al. data**", fig.align = "center"}
...
```{r goos-predicted-pairs-full, cache = TRUE, echo = FALSE, eval = TRUE, fig.cap = "**Table 3B-H. Significant co-binder TFs, inferred using motif comparison with pooled motif library from all species and when such pairs are not found in PPI Goos er al. data**", fig.align = "center"}
