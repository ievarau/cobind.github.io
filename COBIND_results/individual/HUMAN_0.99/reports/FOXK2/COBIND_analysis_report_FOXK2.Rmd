...
## Spacings:
spacings.heatmap.file               <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/clustering_results/FOXK2/spacings/TF_cobinder_spacer_plot_FOXK2.RData"
spacings.summary.tab.file           <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/clustering_results/FOXK2/spacings/spacings_summary.RData"

## Cobinder regions:
cobinder.regions.dir                <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/cobinder_regions/BED"

## PPI:
PPI.motif.similarity.files          <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/physical/FOXK2/cobinder_0_motif_similarity_PPI_plot_with_alignment.RData"
no.mach.motif.similarity.files      <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/physical/FOXK2/cobinder_0_no_match_motif_similarity_plot_with_alignment.RData"

confirmed.pairs.tab.file            <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/physical/FOXK2/motif_ppi_confirmed_pairs.txt"
novel.predictions.file              <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/physical/FOXK2/novel_cobinder_predictions.txt"
confirmed.pairs.full.tab.file       <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/physical_full/FOXK2/motif_ppi_confirmed_pairs.txt"
novel.predictions.full.file         <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/physical_full/FOXK2/novel_cobinder_predictions.txt"
...
goos.no.mach.motif.similarity.files      <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/goos/FOXK2/cobinder_0_no_match_motif_similarity_plot_with_alignment.RData"

goos.confirmed.pairs.tab.file            <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/goos/FOXK2/motif_ppi_confirmed_pairs.txt"
goos.novel.predictions.file              <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/goos/FOXK2/novel_cobinder_predictions.txt"
goos.confirmed.pairs.full.tab.file       <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/goos_full/FOXK2/motif_ppi_confirmed_pairs.txt"
goos.novel.predictions.full.file         <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/goos_full/FOXK2/novel_cobinder_predictions.txt"


## Region annotations:

centered.region.anno                <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/cobinder_regions_annotation/centered/FOXK2_chipseeker.RData"

## Conservation:

conservation.plot.files             <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/conservation_analysis/FOXK2/full_motif_specific/cobinder_0_left_2/cobinder_vs_none_of_cobinders.RData,/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/conservation_analysis/FOXK2/full_motif_specific/cobinder_0_right_19/cobinder_vs_none_of_cobinders.RData"
conservation.statistics.tab.file    <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/conservation_analysis/FOXK2/conservation_statistics/wilcox_test_no_vs_with_cobinder.txt"

## GREAT:

great.plot.dirs                     <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/GREAT_analysis/FOXK2/cobinder_specific/cobinder_0"
