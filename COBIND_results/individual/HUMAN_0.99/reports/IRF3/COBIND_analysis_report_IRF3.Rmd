...
## Spacings:
spacings.heatmap.file               <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/clustering_results/IRF3/spacings/TF_cobinder_spacer_plot_IRF3.RData"
spacings.summary.tab.file           <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/clustering_results/IRF3/spacings/spacings_summary.RData"

## Cobinder regions:
cobinder.regions.dir                <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/cobinder_regions/BED"

## PPI:
PPI.motif.similarity.files          <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/physical/IRF3/cobinder_0_motif_similarity_PPI_plot_with_alignment.RData"
no.mach.motif.similarity.files      <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/physical/IRF3/cobinder_0_no_match_motif_similarity_plot_with_alignment.RData"

confirmed.pairs.tab.file            <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/physical/IRF3/motif_ppi_confirmed_pairs.txt"
novel.predictions.file              <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/physical/IRF3/novel_cobinder_predictions.txt"
confirmed.pairs.full.tab.file       <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/physical_full/IRF3/motif_ppi_confirmed_pairs.txt"
novel.predictions.full.file         <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/physical_full/IRF3/novel_cobinder_predictions.txt"
...
goos.no.mach.motif.similarity.files      <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/goos/IRF3/cobinder_0_no_match_motif_similarity_plot_with_alignment.RData"

goos.confirmed.pairs.tab.file            <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/goos/IRF3/motif_ppi_confirmed_pairs.txt"
goos.novel.predictions.file              <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/goos/IRF3/novel_cobinder_predictions.txt"
goos.confirmed.pairs.full.tab.file       <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/goos_full/IRF3/motif_ppi_confirmed_pairs.txt"
goos.novel.predictions.full.file         <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/goos_full/IRF3/novel_cobinder_predictions.txt"


## Region annotations:

centered.region.anno                <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/cobinder_regions_annotation/centered/IRF3_chipseeker.RData"

## Conservation:

conservation.plot.files             <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/conservation_analysis/IRF3/full_motif_specific/cobinder_0_left_7/cobinder_vs_none_of_cobinders.RData"
conservation.statistics.tab.file    <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/conservation_analysis/IRF3/conservation_statistics/wilcox_test_no_vs_with_cobinder.txt"

## GREAT:

great.plot.dirs                     <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/GREAT_analysis/IRF3/cobinder_specific/cobinder_0"
