...
## Spacings:
spacings.heatmap.file               <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/clustering_results/GRHL2/spacings/TF_cobinder_spacer_plot_GRHL2.RData"
spacings.summary.tab.file           <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/clustering_results/GRHL2/spacings/spacings_summary.RData"

## Cobinder regions:
cobinder.regions.dir                <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/cobinder_regions/BED"

## PPI:
PPI.motif.similarity.files          <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/physical/GRHL2/cobinder_0_motif_similarity_PPI_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/physical/GRHL2/cobinder_1_motif_similarity_PPI_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/physical/GRHL2/cobinder_2_motif_similarity_PPI_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/physical/GRHL2/cobinder_3_motif_similarity_PPI_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/physical/GRHL2/cobinder_4_motif_similarity_PPI_plot_with_alignment.RData"
no.mach.motif.similarity.files      <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/physical/GRHL2/cobinder_0_no_match_motif_similarity_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/physical/GRHL2/cobinder_1_no_match_motif_similarity_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/physical/GRHL2/cobinder_2_no_match_motif_similarity_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/physical/GRHL2/cobinder_3_no_match_motif_similarity_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/physical/GRHL2/cobinder_4_no_match_motif_similarity_plot_with_alignment.RData"

confirmed.pairs.tab.file            <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/physical/GRHL2/motif_ppi_confirmed_pairs.txt"
novel.predictions.file              <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/physical/GRHL2/novel_cobinder_predictions.txt"
confirmed.pairs.full.tab.file       <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/physical_full/GRHL2/motif_ppi_confirmed_pairs.txt"
novel.predictions.full.file         <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/physical_full/GRHL2/novel_cobinder_predictions.txt"
...
goos.no.mach.motif.similarity.files      <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/goos/GRHL2/cobinder_0_no_match_motif_similarity_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/goos/GRHL2/cobinder_1_no_match_motif_similarity_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/goos/GRHL2/cobinder_2_no_match_motif_similarity_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/goos/GRHL2/cobinder_3_no_match_motif_similarity_plot_with_alignment.RData,/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/goos/GRHL2/cobinder_4_no_match_motif_similarity_plot_with_alignment.RData"

goos.confirmed.pairs.tab.file            <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/goos/GRHL2/motif_ppi_confirmed_pairs.txt"
goos.novel.predictions.file              <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/goos/GRHL2/novel_cobinder_predictions.txt"
goos.confirmed.pairs.full.tab.file       <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/goos_full/GRHL2/motif_ppi_confirmed_pairs.txt"
goos.novel.predictions.full.file         <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/ppi_associations_results/goos_full/GRHL2/novel_cobinder_predictions.txt"


## Region annotations:

centered.region.anno                <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/cobinder_regions_annotation/centered/GRHL2_chipseeker.RData"

## Conservation:

conservation.plot.files             <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/conservation_analysis/GRHL2/full_motif_specific/cobinder_0_left_2/cobinder_vs_none_of_cobinders.RData,/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/conservation_analysis/GRHL2/full_motif_specific/cobinder_1_left_0/cobinder_vs_none_of_cobinders.RData,/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/conservation_analysis/GRHL2/full_motif_specific/cobinder_1_right_3/cobinder_vs_none_of_cobinders.RData,/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/conservation_analysis/GRHL2/full_motif_specific/cobinder_2_right_2/cobinder_vs_none_of_cobinders.RData,/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/conservation_analysis/GRHL2/full_motif_specific/cobinder_3_right_3/cobinder_vs_none_of_cobinders.RData,/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/conservation_analysis/GRHL2/full_motif_specific/cobinder_4_right_2/cobinder_vs_none_of_cobinders.RData"
conservation.statistics.tab.file    <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/conservation_analysis/GRHL2/conservation_statistics/wilcox_test_no_vs_with_cobinder.txt"

## GREAT:

great.plot.dirs                     <- "/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/GREAT_analysis/GRHL2/cobinder_specific/cobinder_0,/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/GREAT_analysis/GRHL2/cobinder_specific/cobinder_1,/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/GREAT_analysis/GRHL2/cobinder_specific/cobinder_2,/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/GREAT_analysis/GRHL2/cobinder_specific/cobinder_3,/storage/scratch/ieva/COBIND_results/individual/HUMAN_0.99/results/GREAT_analysis/GRHL2/cobinder_specific/cobinder_4"
