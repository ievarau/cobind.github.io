...
for (species.dir in list.of.species.dirs.individual) {
  ...
  if (species_name_ID != "RAT" | species_name_ID != "DRERIO") {
    ...
    ## Individual:
    individual.top.conservation.path <- file.path(species.dir, "all_pvalues_conservation.pdf")
    individual.all.conservation.path <- file.path(species.dir, "top_conserved_cobinders_pvalues_conservation.pdf")
    ...
    #            "' class='img-responsive' alt='' height = '300'>\n"))
    cat(paste0("\n<object data='",
               individual.top.conservation.path,
               "' height = '300px' type='application/pdf'></object>\n"))
    ...
    ## Families:
    families.top.conservation.path <- file.path(families.species.dir, "all_pvalues_conservation.pdf")
    families.all.conservation.path <- file.path(families.species.dir, "top_conserved_cobinders_pvalues_conservation.pdf")
